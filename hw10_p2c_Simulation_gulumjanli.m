...
% fmincon optimization settings
options = optimoptions('fmincon', 'Display', 'iter', 'MaxFunEvals', 1e4);

% Solve optimal control problem
fprintf('Solving constrained optimal control problem...\n')
...
exportgraphics(hf1, 'p2c_state.pdf', 'ContentType', 'vector')
...
grid off
set(gca, 'FontSize', 12, 'LineWidth', 1.2, 'XColor', 'k', 'YColor', 'k')
exportgraphics(hf2, 'p2c_control.pdf', 'ContentType', 'vector')
